...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(laser, new Chemistry.Point(1000, 250), 250, 100, canvas);
    sq.name = 'laser';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(display, new Chemistry.Point(1650, 250), 280, 160, canvas);
    sq.name = 'pannel display';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(optical_bench, new Chemistry.Point(1550, 750), 600, 60, canvas);
    sq.name = 'optical bench';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(photo_detector, new Chemistry.Point(280, 750), 50, 50, canvas);
    sq.name = 'photo detector';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(scale, new Chemistry.Point(280, 250), 500, 50, canvas);
    sq.name = 'scale';
    scene.add(sq);
}
...
function load_higlighted_images() {
    ...
    a1_labels = [
        ...
        new Chemistry.Text('Optical Bench', new Chemistry.Point(1583, 660), canvas),
