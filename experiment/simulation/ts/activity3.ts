...
function activity3() {
	...
	pp.showtitle(
		`<p id="exp-title" style='width: 23vw;'>To determine the divergence of Given Laser Beam</span><p>`,
		3
	);
...
function disable_buttons() {
	...
	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementById('d-inc');
	let btn2: HTMLButtonElement = <HTMLButtonElement> document.getElementById('d-dec');
	let btn3: HTMLButtonElement = <HTMLButtonElement> document.getElementById('i-inc');
	let btn4: HTMLButtonElement = <HTMLButtonElement> document.getElementById('i-dec');
	let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('record-btn');
...
function process_curve_data(std_deviation: number) {
	let mean: number = 0;
	let x_values: number[] = [];
	let y_values: number[] = [];
...
function gauss_distribution(x, std_deviation, mean): number {
	let y = 0;
